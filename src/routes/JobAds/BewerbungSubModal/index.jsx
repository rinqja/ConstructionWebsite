...
export default function BewerbungSubModal(props) {
  const { isShowModalRoad, setIsShowModalRoad } = props;
  ...
  const handleFormData = async () => {
    ...
    if (Object.keys(errors).length > 0) {
      ...
      payload.append("project", "Bewerbung");
      ...
      try {
        ...
        if (applicationResponse.status === 200) {
          ...
          const emailPayload = {
            ...
            text: "Hallo liebes Lübber Team, ihr habt eine neue Bewerbung in euerm System.Liebe Grüße",
          };
  ...
  return (
    <div>
      <div className="bewerbung-modal-wrapper">
        <div className="modal">
          <div className="icon-right" onClick={() => setIsShowModalRoad(false)}>
